...
((n) => {
    ...
    ((u =
        ...
        (o = function (e, t, n, i) {
            ...
            if ("undefined" == u || "function" == u) {
                for (
                    ...
                    else if ("module" === o) s = c[a] = f.module(e);
                    ...
                    this.$results.attr("id", n),
                        ...
                        t.on("results:previous", function () {
                            ...
                            i <= 0 ||
                                ...
                                (n = s.$results.offset().top),
                                (t = t.offset().top),
                                (e = s.$results.scrollTop() + (t - n)),
                                0 === i
                                    ? s.$results.scrollTop(0)
                                    : t - n < 0 && s.$results.scrollTop(e));
                        }),
                        t.on("results:next", function () {
                            var e,
                                t,
                                n = s.getHighlightedResults(),
                                i = s.$results.find(
                                    ".select2-results__option--selectable"
                                ),
                                n = i.index(n) + 1;
                            n >= i.length ||
                                ...
                                (t = s.$results.scrollTop() + i - e),
                                0 === n
                                    ? s.$results.scrollTop(0)
                                    : e < i && s.$results.scrollTop(t));
                        }),
                ...
                return (
                    ...
                    (e.prototype.bind = function (e, t, n) {
                        var i = this,
                            ...
                            e =
                                (e.call(this, t, n),
                                i.$search.attr("aria-describedby", o),
                                t.on("open", function () {
                            ...
                            var e = s.transport(
                                ...
                                function (e) {
                                    ...
                                    e && e.results && Array.isArray(e.results)
                                        ? (e.results = e.results.map(
                                              r.prototype._normalizeItem
                                          ))
                                        : i.options.get("debug") &&
                                          window.console &&
                                          console.error &&
                ...
                return (
                    ...
                    (n.prototype._processTranslations = function (e, t) {
                        for (var n = new g(), i = 0; i < e.length; i++) {
                            ...
                            else s = l.isPlainObject(o) ? new g(o) : o;
                            n.extend(s);
                        }
                        return n;
                    }),
            ...
            function (t, s, o, i) {
                ...
                return (
                    ...
                    (r.prototype._resolveWidth = function (e, t) {
                        ...
                        if ("string" == typeof i)
                            for (
                                var s = i.split(";"), o = 0, r = s.length;
                                o < r;
                                o += 1
                            ) {
                                var a = s[o].replace(/\s/g, "").match(n);
            ...
            function i(e) {
                ...
                if (
                    ...
                    "axis" in n &&
                        ...
                        ((o = -1 * r), (r = 0)),
                    (s = 0 === r ? o : r),
                    "deltaY" in n && (s = r = -1 * n.deltaY),
                    "deltaX" in n && ((o = n.deltaX), 0 === r) && (s = -1 * o),
                    0 !== r || 0 !== o)
                )
                    return (
                        1 === n.deltaMode
        ...
        "function" == typeof u.define && u.define.amd
            ? u.define("jquery-mousewheel", ["jquery"], s)
        ...
        u.define(
            ...
            function (s, e, o, t, r) {
                ...
                return (
                    ...
                    null == s.fn.select2.defaults &&
                        (s.fn.select2.defaults = t),
                    o
                );
            }
        );
