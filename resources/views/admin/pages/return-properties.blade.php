        ...
        Webcam.snap(function (data_uri) {
            ...
            image.onload = function () {
                ...
                if (code) {
                    ...
                    htmx.ajax('GET', '{{ route('admin.search-reservation-to-return') }}?search_value='
                        + encodeURIComponent(code.data), { target: '#reservation-to-return-list' });
...
<section class="p-2 w-full flex">
    <div id="reservation-to-return-list" class="w-full overflow-y-auto">
    </div>
</section>
@endsection