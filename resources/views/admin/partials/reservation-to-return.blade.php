    ...
    <div class="bg-white border border-gray-200 rounded-lg shadow-md overflow-hidden">
        ...
        <div class="flex justify-end bg-gray-50 p-4 border-t border-gray-200">
            <button
                ...
                hx-get="{{ route('admin.reserved-properties-to-return', [
            'reservation_id' => $reservation->id
        ]) }}" hx-swap="innerHTML" hx-trigger="click"
                hx-target="#reserved-properties-to-return-modal-{{$reservation->id}}"
                class="text-indigo-600 hover:text-indigo-800 font-medium cursor-pointer">View
                Items
            </button>
        </div>
    </div>
    <div id="reserved-properties-to-return-modal-{{$reservation->id}}"
