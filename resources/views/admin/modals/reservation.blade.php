        ...
        <div class="flex flex-col mt-1">
            <div class="flex space-x-2 items-center "> 
                ...
                <span class="ml-2 text-blue-500">
                    ...
                    @else
                    {{ $reservation->property->assigned_personel }}
            ...
            <div>
                ...
                <button onclick="document.getElementById('personel-list-{{$reservation->id}}').classList.toggle('hidden')">
            ...
            <div class="flex flex-col">
                ...
                <form action="{{ route('admin.assign-personel') }}" action="GET"  class="flex space-x-1 justify-between items-center">
                   @csrf
                 
                   <input type="hidden" name="reservation_id" value="{{$reservation->id}}"> 
                    <input type="text" name="personel" placeholder="Input Personel name"  class="p-2 block w-[180px] border border-gray-300 rounded">
    
                    <button class="px-4 py-2 bg-green-500 text-green-100 rounded hover:opacity-50">Submit</button>
                </form>
