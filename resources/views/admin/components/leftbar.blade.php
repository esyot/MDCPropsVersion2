...
<div id="sidebar"
    ...
    <div class="first:mt-3 last:mb-12 flex flex-col flex-grow justify-between relative">
        ...
        <!-- Menu Items -->
        <div id="menu-items" class="flex flex-col justify-between relative overflow-hidden">

            <a href="{{ route('dashboard') }}"
                class="flex items-center justify-center text-white hover:text-blue-300 transition duration-200 rounded-lg "
                title="Dashboard">
                <section
                    class="flex justify-center items-center rounded-lg p-2 {{ $page_title == 'Dashboard' ? 'bg-gray-100 text-blue-500 ' : '' }}  ">
                    <i
                        class="fa-solid fa-calendar-days transition-transform duration-300 ease-in-out transform hover:scale-110"></i>
            ...
            @can('can view items')
                ...
                <a href="{{ route('items') }}"
                    ...
                    title="Items">
                    <section
                        class="flex justify-center items-center rounded-lg p-2 {{ $page_title == 'Items' ? 'bg-gray-100 text-blue-500 ' : '' }} ">
                        <i
                            class="fa-solid fa-boxes-stacked transition-transform duration-300 ease-in-out transform hover:scale-110"></i>
            ...
            @can('can manage categories')
                <a href="{{ route('categories') }}"
                    ...
                    title="Categories">
                    <section
                        class="flex justify-center items-center rounded-lg p-2 {{ $page_title == 'Categories' ? 'bg-gray-100 text-blue-500 ' : '' }} ">
                        <i
                            class="fa-solid fa-th-large transition-transform duration-300 ease-in-out transform hover:scale-110"></i>
            ...
            @can('can view transactions')
                <a href="{{ route('transactions') }}"
                    ...
                    title="Transactions">
                    <section
                        class="flex justify-center items-center rounded-lg p-2 {{ $page_title == 'Transactions' ? 'bg-gray-100 text-blue-500 ' : '' }} ">
                        <i
                            class="fa-solid fa-business-time transition-transform duration-300 ease-in-out transform hover:scale-110"></i>
            ...
            <a href="{{ route('users') }}"
                ...
                title="Users">
                <section
                    class="flex justify-center items-center rounded-lg p-2  {{ $page_title == 'Manage Users' ? 'bg-gray-100 text-blue-500' : '' }}">
                    <i
                        class="fa-solid fa-users-gear transition-transform duration-300 ease-in-out transform hover:scale-110"></i>
