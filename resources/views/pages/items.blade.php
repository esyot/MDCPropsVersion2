...
<div class="relative m-4 overflow-y-auto">
    <div class="flex flex-wrap gap-6">
        ...
        @foreach ($items as $item)
            ...
            <div onclick="document.getElementById('item-{{$item->id}}').classList.remove('hidden')"
                class="flex flex-col text-white rounded-lg w-64 h-64 overflow-hidden">
                <!-- Image Container -->
                <div class="flex justify-center items-center bg-gray-200 h-3/4 shadow-inner">
                    <img src="{{ asset('storage/images/categories/' . $currentCategory->folder_name . '/' . $item->img) }}"
                ...
                <div class="bg-blue-500 w-full h-1/4 shadow-md text-center flex flex-col items-center justify-center">
                    ...
                    <h1 class="text-lg font-semibold truncate">{{ $item->qty }} pc/s</h1>
                </div>
            </div>
