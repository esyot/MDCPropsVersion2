        ...
        <div class="relative w-full max-w-md" id="content">
            <form id="upload-form" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex items-end space-x-2 p-4 bg-white rounded-lg shadow-lg">
                    ...
                    <button type="button" class="text-xl px-2 py-2 hover:text-gray-300 text-white"
                    ...
                    <button type="submit"
                        class="px-4 py-2 bg-blue-500 hover:bg-blue-800 text-white rounded-full whitespace-nowrap">Send</button>
                </div>
            </form>
        </div>
    </div>
